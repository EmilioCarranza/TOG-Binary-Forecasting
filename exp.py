...
orderbookspd= pd.DataFrame.from_dict(orderbooks)
pd.DataFrame.to_csv(orderbookspd)
orderbookspd=pd.DataFrame.from_dict({(i,j): orderbooks['binance'][i][j]
                           for i in orderbooks['binance'].keys()
                           for j in orderbooks['binance'][i].keys()},
                       orient='index')
orderbookspd.to_csv('orderbooks.csv',)

publictradespd= pd.DataFrame.from_dict()
...
spread = orderbooks['binance'][list(orderbooks['binance'])[2]]['ask_price'][0] - orderbooks['binance'][list(orderbooks['binance'])[2]]['bid_price'][0]
spread*10000 # puntos base

# spread , midprice (promedio entre ask y bid)
midprice = (orderbooks['binance'][list(orderbooks['binance'])[2]]['ask_price'][0] + orderbooks['binance'][list(orderbooks['binance'])[2]]['bid_price'][0])*.05

# weighted midprice como midprice pero multiplicados por los volumenes
weighted_midprice = ((orderbooks['binance'][list(orderbooks['binance'])[2]]['ask_price'][0])*(orderbooks['binance'][list(orderbooks['binance'])[2]]['ask_vol'][0]) + (
    (orderbooks['binance'][list(orderbooks['binance'])[2]]['bid_price'][0])*(orderbooks['binance'][list(orderbooks['binance'])[2]]['bid_vol'][0])))*.05
